...
export const KioskListPageContent: React.FC = () => {
	...
	const handleViewDetail = (kiosk: Kiosk) => {
...
const KioskList: React.FC<KioskListPageContentProps> = ({ isLoading, kiosks, pagination, viewMode, actions }) => {
	const tableColumns = [
		'code', 'name', 'connectionStatus', 'locationAddress',
		'isArchived', 'mode', 'warnings',
		'stateTemperature', 'stateHumidity',
		'stateCurrent', 'stateEnergy',
		'statePower', 'stateOutputDoorSwitch',
		'actions',
	];
