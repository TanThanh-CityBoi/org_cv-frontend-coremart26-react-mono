...
import { registerMicroAppI18nResources } from '@nikkierp/ui/i18n';
import {
...
import { useMenuBarItems } from './common/hooks';
import { vendingMachineShellI18nPatch } from './common/i18n/shellI18nPatch';
...
const bundle: MicroAppBundle = {
	init({ htmlTag, registerReducer }) {
		registerMicroAppI18nResources(vendingMachineShellI18nPatch);
