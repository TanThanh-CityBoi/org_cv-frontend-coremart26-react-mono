		...
		() => [
			{
				...
				placeholder: translate('coremart.vendingMachine.mediaPlaylist.search.placeholder'),
			},
			{
				key: 'isArchived',
				...
				placeholder: translate('coremart.vendingMachine.mediaPlaylist.filter.status'),
