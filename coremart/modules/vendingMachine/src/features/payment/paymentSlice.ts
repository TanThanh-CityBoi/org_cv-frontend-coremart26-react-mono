...
import { basePagedReduxState, PagedReduxState, PagedSearchResponse, RestArchiveResponse, SearchOrder, SearchParams } from '@/types';
...
export type PaymentState = {
	...
	list: PagedReduxState<PaymentMethod>;
