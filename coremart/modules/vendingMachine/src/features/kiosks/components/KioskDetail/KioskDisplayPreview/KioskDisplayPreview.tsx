...
import { Badge, Box, Button, Card, Center, Group, Image, Modal, SimpleGrid, Stack, Text, Title } from '@mantine/core';
...
export interface MediaPlaylistPreviewProps {
	playlist: Playlist;
	primaryColor?: string;
	imageUrl?: string;
...
export const KioskDisplayPreview: React.FC<MediaPlaylistPreviewProps> = ({
	...
	return (
		<PreviewModal opened={opened} handleClose={handleClose}>
			<Stack
				mah={700}
				h='100%'
				w='auto'
